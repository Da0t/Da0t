...
![React](https://img.shields.io/badge/React-B20000?style=for-the-badge&logo=react&logoColor=white)
...
![Claude](https://img.shields.io/badge/Claude_API-B20000?style=for-the-badge&logoColor=white)
![Deepgram](https://img.shields.io/badge/Deepgram-B20000?style=for-the-badge&logoColor=white)
![TwelveLabs](https://img.shields.io/badge/TwelveLabs-B20000?style=for-the-badge&logoColor=white)
...
<p align="center">
  <img src="./profile/stats.svg" alt="Dat's GitHub stats" height="180"/>
  <img src="./profile/top-langs.svg" alt="Top languages" height="180"/>
</p>

<!--
  These two cards are generated by a GitHub Action (.github/workflows/readme-stats.yml)
  every 24 hours and committed as static SVGs into the /profile folder of this repo.
  Colors are baked in at generation time: title/icon/ring = B20000 (UCSD red),
  background = 0d1117, text = white. Because they are static files served from your
  own repo, they render reliably and never hit the broken-image / rate-limit issue.

  The cards will NOT appear until the Action has run at least once and created
  profile/stats.svg and profile/top-langs.svg. Run it manually the first time from
  the repo's Actions tab (Update README cards > Run workflow).

  To change the red later, edit the color values in the workflow file and rerun it.
-->
